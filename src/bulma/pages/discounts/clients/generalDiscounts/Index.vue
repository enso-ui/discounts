        ...
        tablePath() {
            switch (this.filters.mode) {
                case this.enums.discountTypes.General:
                    return this.route('discounts.clients.generalDiscounts.initTable');
                case this.enums.discountTypes.Product:
                    return this.route('discounts.clients.productDiscounts.initTable');
                case this.enums.discountTypes.Service:
                    return this.route('discounts.clients.serviceDiscounts.initTable');
            }
        }
    }
