        ...
        tablePath() {
            switch (this.filters.mode) {
                case this.enums.discountTypes.General:
                    return this.route('discounts.clientDiscounts.initTable');
                case this.enums.discountTypes.Product:
                    return this.route('discounts.clientProductDiscounts.initTable');
                case this.enums.discountTypes.Service:
                    return this.route('discounts.clientServiceDiscounts.initTable');
            }
        }
    }
