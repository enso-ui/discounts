        ...
        tablePath() {
            switch (this.filters.mode) {
                case this.enums.discountTypes.General:
                    return this.route('discounts.suppliers.generalDiscounts.initTable');
                case this.enums.discountTypes.Product:
                    return this.route('discounts.suppliers.productDiscounts.initTable');
                case this.enums.discountTypes.Service:
                    return this.route('discounts.suppliers.serviceDiscounts.initTable');
            }
        }
    }
